...
# =============================================================================
print("\n" + "=" * 80)
print("РАЗДЕЛ 3. ПРЕДОБРАБОТКА И ИНЖЕНЕРИЯ ПРИЗНАКОВ")
print("=" * 80)
...
class FeatureEngineer:
    ...
    def create_velocity_features(self, df):
        ...
        if "loan_1h_base_limit" in df.columns and "loan_24h_base_limit" in df.columns:
            df["loan_velocity_1h_24h"] = df["loan_1h_base_limit"] / (df["loan_24h_base_limit"] + 1e-8)
...
# =============================================================================
print("\n" + "=" * 80)
print("РАЗДЕЛ 4. ПОДГОТОВКА ДАННЫХ К МОДЕЛИРОВАНИЮ")
print("=" * 80)


class DataPreparer:
    def __init__(self, target_col="fraud_flg", time_col="order_creation_dttm", test_size=0.2, val_size=0.15):
...
preparer = DataPreparer(target_col="fraud_flg", time_col="order_creation_dttm")
